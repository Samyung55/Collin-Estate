...
const HouseDetails = () => {
  ...
  return (
    <>
    <Navbar></Navbar>
      <Stack height='max-content' py='28' direction={{ base: 'column', md: 'row' }} justify='space-between' align={{ md: 'center' }} my='px'>
        <Box>
          <Heading my='' fontSize='22px'>{searchedHouse?.name}</Heading>
      ...
      <Stack my='-20' direction={{ base: 'column', lg: 'row' }} gap='6' align='flex-start'>
        <VStack align='left' maxW='640px'>
          ...
          <Text my='10' fontSize='15px'>{searchedHouse?.description}</Text>
